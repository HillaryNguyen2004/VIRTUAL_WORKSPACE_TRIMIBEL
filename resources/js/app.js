...
jquery("#toggleMicrophone").on("click", async function () {
  if (micOn) {
    jquery("#toggleMicrophone").removeClass("bg-gray-500").addClass("bg-gray-400");
    micOn = false;
...
jquery("#toggleCamera").on("click", async function () {
  if (cameraOn) {
    jquery("#toggleCamera").removeClass("bg-gray-500").addClass("bg-gray-400");
    jquery("#toggleScreen").removeClass("bg-gray-500").addClass("bg-gray-400");
    cameraOn = false;
    ...
    jquery("#toggleCamera").removeClass("bg-gray-400").addClass("bg-gray-500");
    cameraOn = true;
    await meeting.startVideo();
    localVideoStream = await meeting.getLocalVideoStream();
    jquery("#localVideoTag")[0].srcObject = localVideoStream;
...
jquery("#toggleScreen").on("click", async function () {
  if (screenSharingOn) {
    ...
    jquery("#toggleScreen").removeClass("bg-gray-400").addClass("bg-gray-500");
    jquery("#toggleCamera").removeClass("bg-gray-500").addClass("bg-gray-400");
