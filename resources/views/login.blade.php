...
@section('content')
    ...
    <div class="h-full w-full md:w-1/2">
        <div class="h-full flex items-center justify-center gap-5 py-16 px-4 bg-white w-full">
            <div class="flex flex-col items-center justify-center w-full h-full">

                <h1 class="text-xl md:text-3xl font-medium text-gray-900 text-center">Login to dashboard page</h1>
                <p class="text-sm md:text-base mt-2 text-center text-gray-500">Fill the form below to login</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4 w-full md:w-80 lg:w-96">
                    @csrf
                    <!-- Divider -->
    ...
    <!-- Right -->
    <div class="bg-panel-right-gradient rounded-3xl w-1/2 min-h-[70vh] md:block hidden"></div>
@endsection