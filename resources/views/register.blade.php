...
@section('content')
    ...
    <!-- Left -->
    <div class="bg-panel-left-gradient rounded-3xl min-h-[70vh] md:block md:w-[626px] hidden"></div>

    <!-- Logo -->
    <div class="fixed top-10 right-10 z-50">Logo</div>
    <!-- Right -->
    <div class="h-full w-[600px] scale-75 md:scale-100">
        <div class="h-full flex items-center justify-center py-16 px-4 bg-white w-full">
                ...
                <form method="POST" action="{{ route('register.post') }}" class="mt-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="first_name" name="first_name" type="text" placeholder="First Name" class="mt-1 block w-full rounded-xl border border-gray-300 px-4 py-3
                        ...
                        <div>
                            ...
                            <input id="last_name" name="last_name" type="text" placeholder="Last Name" class="mt-1 block w-full rounded-xl border border-gray-300 px-4 py-3
                               placeholder-gray-400 hover:border-gray-400 focus:outline-none
                               focus:border-[#5D3FD3] transition text-[#5D3FD3]" />
                            @error('last_name')
                                <span class="text-red-400 text-xs">{{ $message }}</span>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="email" name="email" type="email" placeholder="Email" class="mt-1 block w-full rounded-xl border border-gray-300 px-4 py-3
                               placeholder-gray-400 hover:border-gray-400 focus:outline-none
                               focus:border-[#5D3FD3] transition text-[#5D3FD3]" />
                            @error('email')
                                <span class="text-red-400 text-xs">{{ $message }}</span>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="password" name="password" type="password" placeholder="Password" class="mt-1 block w-full rounded-xl border border-gray-300 px-4 py-3 pr-12
                                        placeholder-gray-400 hover:border-gray-400 focus:outline-none
                                        focus:border-[#5D3FD3] transition text-[#5D3FD3]" />
                                <button type="button" id="togglePwd" class="absolute inset-y-0 right-2 p-3"
                                    ...
                                    <svg data-icon="eye-closed" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                                        class="w-5 h-5 fill-gray-400 hidden">
                                        <path
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="password_confirmation" name="password_confirmation" type="password"
                                    placeholder="Confirm password" class="mt-1 block w-full rounded-xl border border-gray-300 px-4 py-3 pr-12
                                        placeholder-gray-400 hover:border-gray-400 focus:outline-none
                                        focus:border-[#5D3FD3] transition text-[#5D3FD3]" />
                    ...
                    <!-- Submit -->
                    <button type="submit" id="submit-btn" class="w-full h-12 rounded-xl text-white font-medium bg-btn-login
                    ...
                    <a href="{{ route('google.login') }}"
                        ...
                        <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt=""
                            class="h-4 w-4">
                        <span class="text-sm font-medium text-gray-700">Register with Google</span>
                    </a>
                </form>
            </div>
        </div>
