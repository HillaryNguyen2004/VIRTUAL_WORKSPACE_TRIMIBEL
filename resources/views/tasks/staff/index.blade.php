        ...
        <table class="w-full">
            <thead class="bg-gray-100 text-gray-500 text-sm uppercase">
                <tr>
                    ...
                    <th class="py-3 px-3">{{ __('tasks.due_date') }}</th>
                    <th class="py-3 px-3">{{ __('tasks.status') }}</th>
                    <th class="py-3 px-3">{{ __('tasks.active') }}</th>
            ...
            @forelse($projects as $project)
                ...
                <tr class="bg-indigo-50">
                    <td colspan="5" class="py-3 px-4 font-semibold flex justify-between items-center">
                        <div>
                            📁 {{ $project->title }}
