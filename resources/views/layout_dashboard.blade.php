...
<body id="page-top" class="flex flex-row bg-canvas/50 text-main font-nunito antialiased h-screen overflow-hidden">
            ...
            <ul class="flex flex-col gap-2 justify-start sm:w-[220px]">
                ...
                <li>
                    <x-nav-link href="{{ route('calendar') }}" :active="request()->routeIs('calendar*')"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5 transition-colors {{ request()->routeIs('calendar*') ? 'text-primary' : 'text-muted-400 group-hover:text-primary' }}" fill="none"
                ...
                <li>
                    <x-nav-link href="{{ route('meeting') }}" :active="request()->routeIs('meeting*')"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 h-6 transition-colors {{ request()->routeIs('meeting*') ? 'text-primary' : 'text-muted-400 group-hover:text-primary' }}" fill="none"
                            stroke="currentColor" stroke-width="2">
                            <path
    ...
    <div class="flex flex-col w-full h-full min-h-0">
        ...
        <nav class="flex justify-between xl:justify-end pl-10 pr-10 xl:pr-[64px] py-3 bg-white border-muted-200 shadow-[0_4px_40px_0_rgba(206,197,242,0.2)] z-20 shrink-0">
            ...
            <ul class="flex flex-row gap-5 items-center">
                <li>
                    ...
                    <div class="relative" id="langMenu">
                        <button id="langButton" type="button" class="inline-flex items-center gap-1 rounded-xl px-2 py-1 text-md font-medium text-muted-600
                            ...
                            @if ($currentLocale === 'en')
                                <div class="flex items-center gap-1"><div>🇺🇸</div></div>
                            @else
                                <div class="flex items-center gap-1"><div>🇻🇳</div></div>
                            @endif
                    ...
                    <div class="relative" id="notificationMenu">
                        ...
                        <div id="notificationPanel" class="absolute left-1/2 -translate-x-1/2 z-20 mt-2 w-60 md:w-64 lg:w-96 origin-top rounded-xl bg-white shadow-lg ring-1 ring-muted-200 border border-muted-200
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-2 py-3 px-4 w-full">
                                ...
                                <button id="markAllRead" class="text-sm text-primary hover:text-primary-hover font-medium">{{ __('app.mark_all_as_read') }}</button>
                            </div>
                            ...
                            <div class="flex items-center justify-center p-1">
                                <button class="w-full rounded-md py-2 text-sm text-secondary hover:bg-secondary/10 transition-colors">
                ...
                <li>
                    <button id="navbar-chatbot-toggle" title="Chat Bot"
                        class="p-1 flex items-center justify-center rounded-full  hover:opacity-95 transition" onclick="toggleRightSidebar()">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="w-6 h-6 fill-muted-400 hover:fill-muted-500 transition-colors">
                            <path
    ...
    <div class="flex flex-row h-full overflow-hidden relative">
        ...
        <div id="main-content-area" class="flex-1 overflow-y-auto w-full transition-all duration-300">
            ...
            <div class="fixed bottom-5 right-5 flex flex-col items-end gap-3 z-30 transition-all duration-300" id="floating-actions">
        ...
        ">
            ...
            {{-- Header --}}
            <div class="flex items-center justify-between gap-3 bg-gradient-to-tl from-[#F1EFFC] to-[#5D3FD3] h-20 px-6 shrink-0 min-w-[100vw] sm:min-w-[400px]">
            ...
            {{-- Chat (scrollable) --}}
            <div id="chat-section" class="flex-1 overflow-y-auto px-3 py-4 space-y-3 min-w-[100vw] sm:min-w-[400px]">
                <div class="flex items-end gap-2">
                    <div class="flex items-center justify-center rounded-full p-2 border bg-white">
                        <img src="{{ asset('img/bot.png') }}" alt="" class="w-6 h-6">
                    </div>
                    <div class="max-w-[280px] shadow-lg rounded-2xl px-3 py-2 border border-gray-300 bg-gray-50 text-sm">
            ...
            {{-- send section --}}
            <div class="h-20 px-3 py-2 border-t border-gray-300 shrink-0 flex items-center gap-2 min-w-[100vw] sm:min-w-[400px] bg-white">
